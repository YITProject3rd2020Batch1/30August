...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2020 at 02:44 PM
...
CREATE TABLE `complaint` (
  ...
  `asgd_po` varchar(20) DEFAULT NULL,
  `adm_rmk` varchar(50) DEFAULT NULL,
  `usr_rmk` varchar(50) DEFAULT NULL,
...
(12, 'Robbery', '2020-08-22', 'gckgvjhn', 'kdnkmsd', 'jsdnck', NULL, NULL, NULL, NULL),
(15, 'Robbery', '2019-04-20', 'NSDBCJND', 'hscbn', 'HSBJSK', NULL, NULL, NULL, NULL),
...
INSERT INTO `registration` (`name`, `email`, `pass`, `adds`, `ph_no`, `gender`, `sec_qn`, `sec_ans`, `utype`) VALUES
('bxv bnn', 'abc', '123', 'sczx', '987654', 'female', 'mother\'s name', '123', 'user'),
('admin', 'admin123@gmail.com', 'a1d2m3', '', '', '', '', '', 'admin'),
('anu', 'anu123@gmail.com', 'an456', 'naz manzil kukkikatte udupi', '9885493331', 'female', 'mother\'s name', 'netravathi', 'user'),
('FXGFCHGVHV', 'BJBN NNM', 'JBHHJ', 'HGFVJHBHGG', '786564654', 'female', 'mother\'s name', 'MN .M,N.M,', 'user'),
('dimpi', 'dimpi45@gmail.com', 'dimpi45', 'shree devikrupa haedmane house nallur karkala taluk udupi ', '9880065412', 'female', 'favourite actress', 'aishwarya rai', 'user'),
('asdf', 'fgghv', 'vh', 'vhbj,khb', '', 'female', 'mother\'s name', 'hv gb,', 'user'),
('nanana', 'mamamam', 'aaa', 'aaasaasas', '7896541', 'female', 'mother\'s name', 'aaaaa', 'user'),
('cvcxvxc', 'naga@gmai.com', '123', 'adfbfdb', '', 'female', 'mother\'s name', 'radha', 'user'),
('pranitha', 'pranitha12@gmail.com', 'pra123', 'venka kripa  banagady post kallmundkur moodbidri taluk dakshina kannada', '9880094321', 'female', 'favourite book', 'to kill a mockbird', 'user'),
('rahul', 'rahul11@gmail.com', 'ra12hul', 'shanthi villa basavana gudi bangalore', '7554189652', 'male', 'favorite actor', 'varun dhawan', 'user'),
('varuni', 'var12uni@gmail.com', '1two3', 'vaishnavi house nelagudde yelattur mangalore taluk dakshina kannada', '8213956474', 'female', 'favourite actor', 'ranbir kapoor', 'user');
